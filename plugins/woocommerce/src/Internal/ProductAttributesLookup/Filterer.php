...
class Filterer {
	...
	public function filter_by_attribute_post_clauses( array $args, \WP_Query $wp_query, array $attributes_to_filter_by ) {
		...
		if ( apply_filters('woocommerce_filterer_hide_out_of_stock', ( 'yes' === get_option( 'woocommerce_hide_out_of_stock_items' ) ) ) ) {
	...
	private function get_product_counts_query_using_lookup_table( $tax_query, $meta_query, $taxonomy, $term_ids ) {
		...
		$hide_out_of_stock = apply_filters('woocommerce_filterer_hide_out_of_stock', ( 'yes' === get_option( 'woocommerce_hide_out_of_stock_items' ) ) );
